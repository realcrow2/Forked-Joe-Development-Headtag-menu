...
local mainMenu = RageUI.CreateMenu("Headtag Menu", "~b~Headtag Menu", 1400, 100, (Config.Custombanner.enabled and 'headtag:banner' or nil), (Config.Custombanner.enabled and 'headtag:banner' or nil), 255, 255, 255, 255)
